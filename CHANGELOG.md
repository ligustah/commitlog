...
green, but by two downstream consumers reading one sentence in its remedy list and
acting on it differently. Doc and check changes only; no behaviour change, and the
single test change is pacing.
